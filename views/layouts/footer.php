        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
            <div class="grid grid-cols-1 md:grid-cols-4 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        <li><a href="#" class="text-gray-600 hover:text-gray-900">Concerts</a></li>
                        <li><a href="#" class="text-gray-600 hover:text-gray-900">Festivals</a></li>
                        <li><a href="#" class="text-gray-600 hover:text-gray-900">Sport</a></li>
                        <li><a href="#" class="text-gray-600 hover:text-gray-900">Théâtre</a></li>
                    </ul>
                </div>
                ...
                <div>
                    ...
                    <ul class="space-y-3">
                        ...
                        <li><a href="#" class="text-gray-600 hover:text-gray-900">Remboursements</a></li>
                    </ul>
                </div>
